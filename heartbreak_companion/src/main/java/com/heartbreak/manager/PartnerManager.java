...
public class PartnerManager {
    ...
    public static void assignRoles(MinecraftServer server) {
        ...
        if (c != null) {
            ...
            arrow.set(DataComponentTypes.CUSTOM_NAME, Text.literal("Cupid's Arrow").formatted(Formatting.LIGHT_PURPLE, Formatting.BOLD));
        ...
        if (h != null) {
            ...
            sword.set(DataComponentTypes.CUSTOM_NAME, Text.literal("Heartbreaker's Dagger").formatted(Formatting.RED, Formatting.BOLD));
